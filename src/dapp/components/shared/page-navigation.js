...
export default class PageNavigation extends CustomElement {
    ...
    getPages() {
        return [{ name: 'home', title: 'Home', route: '/'}].concat([{"name":"ipfs","title":"IPFS Documents","description":"InterPlanetary File System (decentralized file storage)","category":"File Storage","route":"/ipfs"}]); 
    }
